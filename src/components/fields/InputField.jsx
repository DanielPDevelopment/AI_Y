...
const InputField = (props) => {
  const {
    ...
    hasBorder = true, autocomplete, value, min, max, extraParent,
  } = props;
  ...
  return (
    <div className={`${extraParent}`}>
      ...
      <input
        ...
        className={`rounded-xl border border-gray-300/40 bg-white/0 p-3 text-sm outline-none text-white ${disabled === true
